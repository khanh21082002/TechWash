...
public class Booked implements Serializable {
    ...
    public Booked(String hinh, String auto, String diachi, String gia, String hinh2, String hinh3, String hinh4, String DiachiCT, String mota, String ngayden, String ngaydi, String tongtien, String slphongdon, String Sdtks, Boolean status) {
        this.hinh = hinh;
        this.auto = auto;
        this.diachi = diachi;
        this.gia = gia;
